...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/:locale(en|es)/contact/26", destination: "/:locale/contact/clnica-san-miguel-blanco", permanent: true },
      { source: "/contact/26", destination: "/contact/clnica-san-miguel-blanco", permanent: true },
      ...
      { source: "/:locale(en|es)/contact/27", destination: "/:locale/contact/clnica-san-miguel-jefferson", permanent: true },
      { source: "/contact/27", destination: "/contact/clnica-san-miguel-jefferson", permanent: true },
      ...
      { source: "/:locale(en|es)/contact/13", destination: "/:locale/contact/houston-tx-office", permanent: true },
      { source: "/contact/13", destination: "/contact/houston-tx-office", permanent: true },
      ...
      { source: "/:locale(en|es)/contact/6", destination: "/:locale/contact/garland", permanent: true },
      { source: "/contact/6", destination: "/contact/garland", permanent: true },
      { source: "/:locale(en|es)/contact/16", destination: "/:locale/contact/fresnotx", permanent: true },
      { source: "/contact/16", destination: "/contact/fresnotx", permanent: true },
