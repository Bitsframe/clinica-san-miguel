...
export const CommunityMission = () => {
  ...
  return (
    <section className="bg-[#0F172A] text-white rounded-2xl p-6 md:p-10 w-full max-w-6xl lg:max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
  {/* Left Side - Mission */}
  <div className="flex-1 space-y-0 relative">
    ...
    <div className="relative w-full h-[500px] z-20 translate-y-20">
